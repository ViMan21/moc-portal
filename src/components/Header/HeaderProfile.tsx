import { Menu, UnstyledButton, Group, Avatar, Text, useMantineTheme } from "@mantine/core";
import { IconChevronDown, IconShoppingCart, IconStar, IconLogs, IconReport, IconSettings, IconSwitchHorizontal, IconLogout } from "@tabler/icons-react";
    ...
    return (
      ...
      >
        ...
        <Menu.Dropdown> 
          ...
          <Menu.Item
            leftSection={<IconReport size={16} color={theme.colors.red[6]} stroke={1.5} />}
          >
            Reports
          </Menu.Item>
